...
namespace project
{
    public partial class AD_FormTL : Form
    {
        public AD_FormTL()
        {
            ...
            cbSV.Items.Add(string.Format(@"{0}", Environment.MachineName));
        ...
        public void GetDatabaseList()
        {
            ...
            //string conString = @"Data Source=DESKTOP-QPM2SL3\SQLEXPRESS;Initial Catalog=QuanLiThiTracNghiem;Integrated Security=True;User ID =sa;Password=sa";
                ...
                using (SqlCommand cmd = new SqlCommand("SELECT name from sys.databases", con))
                {
                    using (IDataReader dr = cmd.ExecuteReader())
                    {
                        while (dr.Read())
                        {
                            ...
                            //cbb_databasebackup.Items.Add(dr[0].ToString());
                            //cbb_databaserestore.Items.Add(dr[0].ToString()); ;
                        }
                    }
                }
            }
